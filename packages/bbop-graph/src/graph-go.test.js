...
import go_nodes from "./fixtures/go.nodes.json" with { type: "json" };
import go_edges from "./fixtures/go.edges.json" with { type: "json" };
...
describe("test using GO data", function () {
  it("all good", function () {
    ...
    for (var e = 0; e < go_edges.length; e++) {
      ...
      //print('index: ' + e);
      g.add_edge(new model.edge(jedge["subject"], jedge["object"], jedge["predicate"]));
    }
